...
const modals = () => {
  ...
  function bindModal({
    ...
    modal.querySelectorAll(closeSelector).forEach(item => item.addEventListener("click", closeModal));
    if (overlayClickClose) window.addEventListener("click", e => e.target === modal && closeModal());
    function closeModal() {
...
/***/ "./src/js/modules/setFormState.js":
/*!****************************************!*\
  !*** ./src/js/modules/setFormState.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const setFormState = state => {
  ...
  const checkboxes = formInputs.filter(box => box.getAttribute("type") === "checkbox");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (setFormState);
...
/* harmony import */ var _modules_setFormState__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/setFormState */ "./src/js/modules/setFormState.js");
...
document.addEventListener("DOMContentLoaded", () => {
  let formState = {};
  (0,_modules_setFormState__WEBPACK_IMPORTED_MODULE_5__["default"])(formState);
  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])();
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])();
  (0,_modules_timers__WEBPACK_IMPORTED_MODULE_3__["default"])();
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"])(formState);
  (0,_modules_lightbox__WEBPACK_IMPORTED_MODULE_6__["default"])();
});
})();
